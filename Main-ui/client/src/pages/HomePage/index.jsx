        ...
        <div className='Home'>
            <div className='Home-button'>
                ...
                <div className='Home-button-2'>
                    <Button onClick={toggle} color="primary" variant="contained">Viết bài <CreateIcon /></Button>
                    {/*Modal: Hiện pop-up để đăng bài */}

                    <Modal isOpen={modal} toggle={toggle}>
                        <ModalHeader  toggle={toggle}>Add a post ✍️</ModalHeader>
                        <ModalBody>
                            <Input name="title" type="text" placeholder="title" onChange={onChange} value={postData.title}/>
                            <Input name="content" type="text" placeholder="content" onChange={onChange} value={postData.content} />
                        </ModalBody>
                        <ModalFooter>
                            <LoadingButton loading={postLoading} color="primary" onClick={post}  >POST IT</LoadingButton>
